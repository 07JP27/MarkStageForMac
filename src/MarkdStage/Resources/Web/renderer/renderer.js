...
function afterLayout() {
  return new Promise((resolve) => {
    ...
    // WebKit throttles requestAnimationFrame in the hidden render window used by
    // the native macOS PDF exporter. Keep the normal two-frame path, but never
    // let visibility prevent print rendering from completing.
